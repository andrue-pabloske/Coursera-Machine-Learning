...
for i = 1:m
    ...
    %compute cost of example i
    J = J + 1/m * (-y_vec' * log(h) - (1-y_vec)' * log(1-h));
end

Theta1_grad = 1/m * Theta1_grad + lambda/m * Theta1;
Theta1_grad(1:end, 1) = Theta1_grad(1:end, 1) - lambda/m * Theta1(1:end, 1);
Theta2_grad = 1/m * Theta2_grad + lambda/m * Theta2;
Theta2_grad(1:end, 1) = Theta2_grad(1:end, 1) - lambda/m * Theta2(1:end, 1);
